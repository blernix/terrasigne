        ...
        >
          {cat.services.map((svc, sidx) => (
            <SwiperSlide key={sidx}>
              <div className="aspect-square max-w-lg flex flex-col justify-between rounded-xl bg-[#f9f9fb] shadow-inner border border-[#e6e6ec] hover:shadow-md hover:scale-[1.02] transition-transform duration-300 ease-out p-6 text-gray-800">
