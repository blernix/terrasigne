...
useEffect(() => {
  ...
  return (
    <>
      <Navbar />
      <main id="main-content" className="bg-[var(--secondary)] min-h-screen">
<section
...
>
 ...
 <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">
   ...
   <br /><br />
   Laisse toi guider, je te propose d&rsquo;évaluer la pratique qui te convient.

   <Link href="/contact" className="w-full block max-w-xs mx-auto">
     <button
       className="w-full px-4 py-2 border border-brandSecondary text-brandSecondary rounded-full text-sm hover:bg-brandSecondary hover:text-white focus:ring-2 focus:ring-brandSecondary focus:ring-offset-2 transition"
     >
...
<div className="relative mx-auto max-w-2xl text-center mt-10 px-4">
  <p className="text-lg italic text-gray-600 font-light leading-relaxed relative before:absolute before:content-['&ldquo;'] before:text-5xl before:-top-6 before:-left-4 before:text-brandOrange after:absolute after:content-['&rdquo;'] after:text-5xl after:-bottom-6 after:-right-4 after:text-brandOrange">
