...
export default function Page() {
  ...
  return (
    <>
      <Navbar />
      <main className="relative bg-[var(--secondary)] min-h-screen w-full px-8 overflow-hidden">

        {/* HERO */}
        <section className="relative text-center max-w-6xl mx-auto mb-24 py-32" data-aos="fade-up">
          {/* 🌳 Arrière-plan Arbre uniquement sur Hero */}
          <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
            <img
              src="/images/arbreTerra.png"
              alt="Arbre Terrasigne"
        ...
        {/* 🍃 Feuilles flottantes sous Hero */}
        <div className="relative w-full mb-24">
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-1 pointer-events-none">
            <img
              src="/images/feuilles.png"
              alt="Feuilles flottantes"
              className="absolute animate-floatSlow opacity-20 w-32 top-10 left-10"
            />
            <img
              src="/images/feuilles.png"
              alt="Feuilles flottantes"
              className="absolute animate-floatSlow opacity-20 w-24 top-1/3 left-1/4"
            />
            <img
              src="/images/feuilles.png"
              alt="Feuilles flottantes"
              className="absolute animate-floatSlow opacity-20 w-28 top-1/2 right-1/3"
            />
            <img
              src="/images/feuilles.png"
              alt="Feuilles flottantes"
              className="absolute animate-floatSlow opacity-20 w-20 bottom-10 right-10"
            />
          </div>
        </div>
